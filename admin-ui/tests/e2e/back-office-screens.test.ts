...
const INTEGRATION_STATUS = {
  ...
  dependencies: [
    ...
    },
    {
      ...
      state: "READY_503",
      detail: "Readiness endpoint returned 503.",
      detail_vi: "Endpoint readiness trả 503; giữ fail-closed.",
      fail_closed_effect: "Order Core down means no new task.",
      observed: true,
      captured_at: "2026-08-15T01:59:15Z",
    },
    {
      dependency: "EVIDENCE_REGISTRY",
      state: "NOT_WIRED",
      detail: "No provider endpoint configured.",
      detail_vi: "Nhà cung cấp=chưa cấu hình; endpoint thật vẫn BLOCKED_EXTERNAL",
      fail_closed_effect: "Evidence registry unavailable keeps final callbacks on hold.",
      observed: false,
    },
  ],
