...
| Python base image | `python:3.12.14-slim-trixie@sha256:7a8b475003c4fe15a2cd4e55e5cfc2f3560bdc9333d624f24cdd6d4340fd7a17`, with exact Debian security updates `libssl3t64`, `openssl`, `openssl-provider-legacy` `3.5.7-1~deb13u2`, and from W-0317 (2026-09-18) `perl-base` `5.40.1-6+deb13u1`, `gzip` `1.13-1+deb13u1`, `libpcre2-8-0` `10.46-1~deb13u2`, `libsqlite3-0` `3.46.1-7+deb13u2` | Base digest and security package versions pinned in `Dockerfile.tts`; included in image SBOM | Release scan/disposition required; unfixed base-OS findings remain release-blocking — 44 HIGH, 0 CRITICAL on 2026-09-18 (`docs/evidence/W-0317/README.md`) |
