...
| R-05/R-13 và §3 “policy/whitelist chưa quyết” | [Register](../../specs/_review/open-decisions-register.md) ghi OD-V1-08/16 ở `M8_POSITION_SIGNED`: M8 đã chốt lập trường `gh-247-prod-v1`, chờ Sếp (phiếu Sếp 25/09 mục N16) — *sửa 25/09 theo chốt chief; bản 21/09 ghi “đã chốt”*. OD-V1-15 đã chọn whitelist rộng. Đây là quyết định nội dung; không phải chứng cứ M3/production hay chữ ký PIA. |
