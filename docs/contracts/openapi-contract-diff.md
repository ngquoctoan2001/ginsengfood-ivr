...
- SHA-256: `f49f4b18362df88d68ebcdc6737632d18158eb926529a7b63cabbb93c1848112`
- Title/version: IVR Order Confirmation — Internal/Admin API (Target V1 Draft) / `1.0.0-draft.2`
...
- Schemas (32): AdminMutationRequest, AdminReviewRequest, CallAttemptLifecycleRequest, CallJobLifecycleRequest, CallResultLifecycleRequest, EligibilityLifecycleRequest, ErrorCode, ErrorEnvelope, FeatureFlagChangeSet, FeatureFlagMutationRequest, FeatureFlagMutationResult, FeatureFlagReadResult, FeatureFlagSnapshot, IvrAdminActionResult, IvrAdminReviewResult, IvrCallAttempt, IvrCallJob, IvrCallResult, IvrConfirmationTaskV1, IvrEligibilityDecision, IvrQueueProjection, IvrResultCallbackLifecycle, IvrTaskIntakeResult, IvrTechnicalRetryResult, KillSwitchVerification, OrderSpeechItem, PrivacySafeOrderSummary, ProgramCode, ResultCallbackLifecycleRequest, ResultType, SellableStatusLine, TechnicalRetryRequest
