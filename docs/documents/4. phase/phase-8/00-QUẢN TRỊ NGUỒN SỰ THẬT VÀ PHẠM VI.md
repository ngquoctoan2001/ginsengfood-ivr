...
> **HISTORICAL_BASELINE / SUPERSEDED OVERLAY — 2026-08-27:** Các đoạn giao quyền cho IVR tự
> quyết định trusted-skip đã bị `OD-18`/`W-0123` thay thế. M3 quyết định task cần gọi; IVR chỉ
> thực thi qua gate kỹ thuật/an toàn. Giữ phần dưới làm baseline lịch sử.
