...
> **HISTORICAL_BASELINE / SUPERSEDED OVERLAY — 2026-08-27:** Các use case IVR tự phân loại khách
> cũ/khách mới hoặc trusted-skip đã bị `OD-18`/`W-0123` thay thế. M3 quyết định task cần gọi; IVR
> chỉ thực thi qua gate kỹ thuật/an toàn.
