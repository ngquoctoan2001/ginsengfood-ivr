...
`7fc9806`. W-0013 thuộc nhóm A1 và chuyển **TESTS_PASS → ACCEPTED** cho phần đã làm: P0-4: cờ
mode/provider và kill switch. Claude ghi nhận quyết định của owner, không tự cấp phê duyệt.

Còn mở, không thuộc nghiệm thu này: OD-V1-20 chờ người ngoài M8 xác nhận; independent approval của
W-0061 (tier GitLab). Mọi giới hạn trong cột Residual của tracker giữ nguyên. Bằng chứng giữ đúng
