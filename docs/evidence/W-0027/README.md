...
| `UT-UI-ROLE-04` | `tests/component/back-office.test.tsx` | 3 | The matrix states Permission Core owns assignment and that no assign/revoke control exists; the permission vocabulary is covered; `IVR_RUNTIME_GATE_ADMIN` is held by no role. |
