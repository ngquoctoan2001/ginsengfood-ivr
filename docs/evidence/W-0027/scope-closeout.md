# W-0027 / P3-3 — Hồ sơ kết thúc phạm vi UI
...
- Phần từng triển khai: Config, integration, seed, roles; [README/capture gốc](README.md) giữ nguyên lịch sử.
...
Script lifecycle/runtime gate/seed đã có work thay thế trước khi UI bị bỏ. M3 chốt UI mới; replay cũ đã thay bằng review, không tuyên bố replay tồn tại. Role do M3 quản lý; KEY_9 vẫn tắt.

| Hành động | Phụ trách | Tình trạng |
| --- | --- | --- |
| Ghi quan hệ work cũ → quyết định bỏ UI và phạm vi chuyển tiếp | Codex | Đã lập hồ sơ này |
| Quyết định kết thúc W-0027 bằng CANCELLED hoặc lựa chọn terminal khác có lý do | Toàn, owner M8 | CANCELLED — Toàn duyệt “oke cả nhóm”, phiếu W-0337 tại8763dc1 |
...
[Quyết định W-0337](../W-0337/approval-request.md#quyết-định-owner--21092026) chốt W-0027 bằng **CANCELLED**. Các câu PENDING
