...
- 3 ID test UI được retire theo quyết định gỡ admin-ui đã ghim, không có test thay thế. Phần backend vẫn phải có test xanh.
...
luôn đi”. Theo [danh sách W-0351](../W-0351/README.md), W-0112 chuyển **TESTS_PASS → ACCEPTED** cho
phần đã làm. Phần backend có test xanh; phát hiện về file mẫu hết hạn đã xử lý ngay trong việc.
