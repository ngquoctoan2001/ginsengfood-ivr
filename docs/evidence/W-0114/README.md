...
`7fc9806`. W-0114 thuộc nhóm A2 và chuyển **TESTS_PASS → ACCEPTED** cho phần đã làm: Cổng rolling
deploy không gãy giữa chừng. Claude ghi nhận quyết định của owner, không tự cấp phê duyệt.

Còn mở, không thuộc nghiệm thu này: cổng không đọc dữ liệu đang có; phần đó thuộc A9. Mọi giới hạn
