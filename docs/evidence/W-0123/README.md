...
| --- | --- | --- |
| M3 producer/consumer usage + sign-off | `OWNER_DATA_REQUIRED` | Chưa có commit/OpenAPI/runtime capture hoặc chữ ký M3. Phiếu để M3 trả lời: `plan/ivr-orther/00-CHUA-XONG.md#m3-od18-authority` (`W-0125`) |
