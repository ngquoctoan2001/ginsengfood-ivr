...
Công cụ/preflight local đủ đề nghị. Hosted CI đã có lượt W-0292 nhưng không toàn bộ PASS; target preflight và phản hồi M3 thật vẫn thiếu. Phiếu hiện hành đã gom vào IR-07, không gửi lại từ lượt này.
...
chín việc. W-0125 được ghi **ACCEPTED** cho đúng phạm vi local đã trình.
