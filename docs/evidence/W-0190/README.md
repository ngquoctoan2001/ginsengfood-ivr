...
`7fc9806`. W-0190 thuộc nhóm A2 và chuyển **TESTS_PASS → ACCEPTED** cho phần đã làm: Sửa API
feature-flag (P0.1). Claude ghi nhận quyết định của owner, không tự cấp phê duyệt.

Còn mở, không thuộc nghiệm thu này: phê duyệt mutation, staging, production nằm ngoài. Mọi giới hạn
