...
Phần expand gốc đủ đề nghị; drill chỉ chứng minh ba43605 → c8dc3c4. Cleanup và rollback một candidate phát hành khác cần bằng chứng riêng, không dùng full test mới để nhận thay.
