...
`7fc9806`. W-0300 thuộc nhóm A2 và chuyển **TESTS_PASS → ACCEPTED** cho phần đã làm: Gỡ phê duyệt
production khỏi migration. Claude ghi nhận quyết định của owner, không tự cấp phê duyệt.

Còn mở, không thuộc nghiệm thu này: OD-V1-08 cần Product, Order Core, M3 đối ký. Mọi giới hạn trong
cột Residual của tracker giữ nguyên. Bằng chứng giữ đúng lượt collector tại `ca4f442` (1200/1200
test, sweep 43/43), không coi commit tài liệu là một lượt test/sweep mới.
