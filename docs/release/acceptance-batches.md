# Danh sách đề nghị nghiệm thu — `26820e7b86597738bb60a01d4bc9b1573161b7fe`
...
| Nguồn | Trạng thái |
| --- | --- |
| Kết quả test (`C2`) | 4 file `.trx`, 1203 kết quả · SHA/hash/đủ project đã kiểm |
...
- `W-0203` — Residual: F-1 đã sửa ở 4483029 (W-0286); F-2 xong: POST /result-callbacks/{callbackId}:replay, contract 1.0.0-draft.32, Module 3 chỉ cần sinh lại client khi muốn gọi; F-3 đúng thiết kế: seed dev đặt kill switch toàn cục bằng tr…
...
- `W-0352` — Residual: W-0011 và W-0055 giữ lại, lý do trong closeout.json; REAL_CUSTOMER_CALL_ALLOWED=NO
