...
**Đang ở nấc 0.** 8/239 work item ở trạng thái `ACCEPTED`; phần còn lại
...
Cả bảy đầu vào đều chưa đạt. **18** work item ở `BLOCKED_EXTERNAL`, và
**5** quyết định `OD-V1-*` còn mở.
