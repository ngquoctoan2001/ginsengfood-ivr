...
| C | C1 | **W-0292: 31 job PASS, pipeline Failed tại `179a5eb`.** Registry/Pages đã publish; dev bootstrap Helm/kubectl PASS rồi thất bại vì cluster unreachable localhost:8080; staging skipped. Còn review độc lập main-only (`G-GITLAB`) và cluster/CSDL/bí mật/DNS/TLS (`G-PLATFORM`) | BLOCKED_EXTERNAL |
