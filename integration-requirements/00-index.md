...
| **[07-module-3-decision-sheet.md](07-module-3-decision-sheet.md)** | **Module 3** | 📤 **Phiếu chốt một vòng — `32` câu** (bản gộp `17/09`, `W-0310`; thêm `M3-31`, `M3-32` ngày `25/09`). **Ghi đã gửi `17/09`** — Toàn xác nhận; anh Mạnh báo `25/09` chưa nhận, phiếu gửi lại kèm đính chính `25/09`; đính chính `draft.31` gửi cùng ngày. Chưa có phản hồi. *(Sửa `18/09`, `W-0316`: dòng này từng ghi "21 mục, gửi `2026-09-10`".)* Không điền coi như đồng ý với vị trí Module 8 đã ghi sẵn. Đang chặn `G-CONTRACT`, `G-SPEECH`, `G-DIAL`, `G-AUTH`, `G-POLICY` | `SENT / AWAITING_REPLY` |
| **[08-module-3-sandbox-guide.md](08-module-3-sandbox-guide.md)** | Module 8 → **Module 3** | 🧪 **Môi trường thử chạy được hôm nay.** Một lệnh là dựng, tài khoản dịch vụ có hạn mức, 28 ví dụ chạy sẵn (có lượt gửi số thay cho token), cách dọn dữ liệu, cách trỏ callback về máy chủ của Module 3. Không phụ thuộc IR-07 | `W-0282 · VERIFIED 24/24` · `W-0312 · 28/28` |
