...
Pin rotation hiện hành: `W-0186` ngày `2026-09-04`. Bản W-0152 gốc cùng các snapshot
W-0170/W-0176/W-0177 vẫn được giữ trong git history. W-0186 phục hồi exact source set đã bị xóa ở
`8ed62e9` và xoay pin `T-09` sau phần hardening fail-closed W-0180; không đổi decision/quorum rule.
...
| `docs/contracts/target-v1-closure-pack/T-09-attempt-policy.md` | `4046e3c1cbeb8d3983da0745f25056968d0960b04b410904369bdb20e987eb11` |
