...
5. Guardrail: reject invalid mode/provider pairs, real adapter in MOCK, non-allowlisted LAB destination, candidate policy in PROD, notification enable, and `realCustomerCallAllowed` without P9 gate.
