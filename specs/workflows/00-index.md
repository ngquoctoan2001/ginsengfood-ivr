...
| [07-trusted-skip.md](07-trusted-skip.md) | `OD-18`: M3 quyết định đơn cần gọi; IVR chỉ kiểm gate kỹ thuật/an toàn và thực thi. Workflow trusted-skip cũ `SUPERSEDED` |
