...
public static class InternalAdminApiServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddOptions<DevToolingOptions>()
            ...
            {
                // W-0190. A relative path is resolved against the content root, not the process
                // working directory.
                //
    ...
    /// <summary>
    /// W-0190. Turns the configured seed path into one the process can actually open.
    /// <para>
