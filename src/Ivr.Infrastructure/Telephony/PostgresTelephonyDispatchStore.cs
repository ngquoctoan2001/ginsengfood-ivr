...
/// W-0199 / <c>OD-V1-05</c>. The token's resolve ceiling for this task: the attempt policy's
    ...
    TimeProvider timeProvider) : ITelephonyDispatchStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new TelephonyDispatchContext(
            ...
            // W-0199. From the task's own snapshot, not from a fresh read of the policy table.
